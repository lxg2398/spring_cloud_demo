package com.gosun.shop.gosunactiviti.testactiviti.parallelGateWay;
...
public class ParallelGateWayTest {
	...
	public void deploymentProcessDefinition_zip(){
		//获取输入流
		InputStream in = this.getClass().getClassLoader().getResourceAsStream("diagrams/ParallelGateWay.zip");
