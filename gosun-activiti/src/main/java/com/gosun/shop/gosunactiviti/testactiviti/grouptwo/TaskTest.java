package com.gosun.shop.gosunactiviti.testactiviti.grouptwo;
...
public class TaskTest {
	...
	public void deploymentProcessDefinition_zip(){
		//获取输入流
		InputStream in = this.getClass().getClassLoader().getResourceAsStream("diagrams/GroupTaskTwo.zip");
		ZipInputStream zipInputStream = new ZipInputStream(in);
		Deployment deployment = processEngine.getRepositoryService()//与流程定义和部署对象相关的Service
				.createDeployment()//创建一个部署对象
				.name("groupTaskTwo")//添加部署的名称
				.addZipInputStream(zipInputStream)//
				.deploy();//完成部署
		System.out.println("部署ID："+deployment.getId());//部署ID：57501
	...
	public void startProcessInstance(){
		...
		/**启动流程实例的同时，设置流程变量，使用流程变量用来指定任务的办理人，对应groupTaskTwo.pbmn文件中#{userNames}*/
		Map<String, Object> variables = new HashMap<String, Object>();
		variables.put("userNames", "大大,中中,小小");
