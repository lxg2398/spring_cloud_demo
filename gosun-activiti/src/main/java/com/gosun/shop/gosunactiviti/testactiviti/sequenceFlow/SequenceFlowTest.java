package com.gosun.shop.gosunactiviti.testactiviti.sequenceFlow;
...
public class SequenceFlowTest {
	...
	public void deploymentProcessDefinition_zip(){
		//获取输入流
		InputStream in = this.getClass().getClassLoader().getResourceAsStream("diagrams/SequenceFlow.zip");
