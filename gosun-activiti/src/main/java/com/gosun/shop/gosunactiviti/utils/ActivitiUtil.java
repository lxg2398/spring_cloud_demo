package com.gosun.shop.gosunactiviti.utils;
...
//
//
//    public static ActivitiUtil startProcess = new ActivitiUtil();
//
//
//    /**
//     * 部署流程定义(zip)
...
//     */
//    @Test
//    public void startProcessDefinition(String key){
//        /**
...
//        runtimeService.startProcessInstanceByKey(key);//通过流程定义的key 启动实例
