...
public class ProcessVariablesTest {
    ...
    /**
     * 部署流程定义（从InputStream）
     * this.getClass().getResourceAsStream("/diagrams/testActiviti.bpmn");
     * this.getClass().getResourceAsStream("/diagrams/testActiviti.bpmn");
     * this.getClass().getClassLoader().getResourceAsStream("/diagrams/testActiviti.bpmn");
     */
    @Test
    ...
    public void setVariables() {
        ...
        /**
         * （实现序列号）放置到流程变量中，要求javabean的属性不能再发生变化
         *    * 如果发生变化，再获取的时候，抛出异常
         *
         * 解决方案：在Person对象中添加：
