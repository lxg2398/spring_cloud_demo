...
public final class RedisPool {
    ...
    public static void returnResource(final Jedis jedis) {
        ...
        if (jedis != null) {
            ...
            jedis.close();//此处jedis.close()并不是销毁连接，而是将连接返回连接池
        }
    }
...
//        System.out.println(resource1.get("sex"));
        ...
        //jedisPool.close();关闭连接池（连接池不能使用了，想要使用必须重新创建）

        //resource.disconnect();表示将连接池中的这个连接断开，不能再次使用了
